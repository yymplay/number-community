...
//						 '<button type="button" class="btn btn-default" id="myColor">设置字体颜色</button>' +
	...
	function initSignature() {
		if (window.requestAnimFrame) {
			...
			signature.jqSignature({ width: w*0.85, height: h/3, border: '1px solid white', background: '#50abf2', lineColor: '#000', lineWidth: 2, autoFit: false });
